...
import { RtmResult, RtmTresholds } from '@/types';
...
export default function DataTableResultsPublic({
    data,
    pageIndex,
    setPageIndex,
    totalPages,
        ...
        <div className="flex w-full flex-col justify-start gap-4">
            <div className="relative flex flex-col gap-4 overflow-auto">
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                    ...
                    <Input placeholder="Cari nama atau alamat..." value={searchValue} onChange={handleSearchChange} className="max-w-sm md:order-1" />
                </div>
